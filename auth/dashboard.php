					...
					<div class="row">						
						<?php 
							if($_SESSION['role'] == 'admin'){ 
								...
								echo '<div><a href="../chat/form.php" style="color:#000;">Add Chatbot Information</div>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>	
						...
						<?php 
							if($_SESSION['role'] == 'user'){ 
								...
								echo '<div><a href="../chat/bot.php" style="color:#000;">Chatbot</div>';
								echo '<a href="price.php" style="color:#000;">Room of your price</a>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>
						...
						<?php
						$foo = include '../app/location/hetauda.php';
						echo $foo;
                        
						//$too = include 'price.php';
						//echo $too;
						?>
					</div>
				</div>
