<?php
	...
	if(isset($_POST['register'])) {
		...
		$minp = $_POST['minp'];
			...
			try {
				$stmt = $connect->prepare('INSERT INTO users (fullname, role, maxp, minp, mobile, username, email, location, password) VALUES (:fullname, :role, :maxp, :minp, :mobile, :username, :email, :location, :password)');
				$stmt->execute(array(
					':fullname' => $fullname,
					':role' => $role,
                    ':maxp' => $maxp,
					   ...
					   <div class="row">
						...
						<div class="col-6">
							...
							<div class="col-6">
							    ...
							    <input type="text" class="form-control" id="role" placeholder="Full Name" name="role" required>
							  </div>
							  <div class="form-group">
							    <label for="maxp">Max Price</label>
							    <input type="text" class="form-control" id="maxp" placeholder="MAXIMUM PRICE" name="maxp" required>
							  </div>
							  <div class="form-group">
							    <label for="minp">Min Price</label>
							    <input type="text" class="form-control" id="minp" placeholder="MINIMUM PRICE" name="minp" required>
							  </div>
							</div>
