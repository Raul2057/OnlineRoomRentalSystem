...
INSERT INTO `room_rental_registrations` (`id`, `fullname`, `mobile`, `alternat_mobile`, `email`, `country`, `state`, `city`, `landmark`, `rent`, `sale`, `deposit`, `plot_number`, `rooms`, `address`, `accommodation`, `description`, `image`, `image_one`,`open_for_sharing`, `other`, `vacant`, `created_at`, `updated_at`, `user_id`) VALUES
(13, 'Ashish Gaikwad', '2345676567', '98888787', 'admin@admin.com', 'india', 'Maharashtra', 'Jalgaon', 'near ramanand police station', '1100', '20000', '5000', '78 nh', '2bhk', 'kolhe nagar, jalgaon', '4', 'nice house', 'uploads/Jalgao1.jpg','uploads/car.png' NULL, 'zx', 0, '2022-05-05 12:21:43', '2022-05-05 12:21:43', 1);
...
INSERT INTO `users` (`id`, `fullname`, `mobile`, `username`, `location`, `email`, `password`, `created_at`, `updated_at`, `role`, `status`) VALUES
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `users_location_unique` (`location`);
