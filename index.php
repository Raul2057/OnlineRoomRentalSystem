  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Search rooms or desired place for hire.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
              ...
              if(count($data) !== 0){
                echo "<h2 class='text-center'>Search Details</h2>";
              }else{
                         ...
                         echo   '<div class="row">
                            ...
                            <h4 class="text-center">Owner Details</h4>';
                              ...
                              if ($value['image'] !== 'uploads/') {
                                # code...
                                echo '<img src="app/'.$value['image'].'" height="200" width="200">';
                              }
                              if ($value['image_one'] !== 'uploads/') {
                                # code...
                                echo '<img src="app/'.$value['image_one'].'" height="200" width="200">';
                              }
   ...
   <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; ROOM RENTAL SYSTEM</span>
          </div>
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="https://www.facebook.com/rajkiran.sapkota">
